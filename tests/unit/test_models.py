...
Run:
    ...
    pytest tests/unit/test_models.py -v -k "abmil"          # only ABMIL tests
    pytest tests/unit/test_models.py -v -k "gradient"        # only gradient tests
    pytest tests/unit/test_models.py -v --tb=short           # shorter tracebacks
