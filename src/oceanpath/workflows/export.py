"""
Stage 5: Export trained MIL model to deployment-ready artifacts.

Pipeline:
  ┌────────────────────┐
  │  Stage 3 (Train)   │  model.ckpt (Lightning checkpoint)
  └────────┬───────────┘
           ▼
  ┌────────────────────┐
...
def _run_export(
    ...
    *,
    ...
    """Stage 5: Export trained model to deployment artifacts."""
    ...
    logger.info("=" * 60)
    logger.info("  Stage 5: Export Model Artifact")
    logger.info("=" * 60)
