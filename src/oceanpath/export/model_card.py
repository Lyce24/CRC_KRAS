    ...
    def build(self) -> dict[str, Any]:
        ...
        card = {
            ...
            "patching": {
                ...
                "target_mpp": _nested_get(cfg, "extraction.target_mpp"),
                "sampling_mode": (
                    "exact_mpp"
                    if _nested_get(cfg, "extraction.target_mpp") is not None
                    else "magnification"
                ),
...
def load_oof_metrics(train_dir: str | Path) -> dict[str, Any]:
    ...
    Falls back to: {train_dir}/eval/evaluation_report.json (from Stage 4).
    """
    ...
    # Fallback: evaluation report from Stage 4
...
def load_threshold_info(eval_dir: str | Path) -> dict[str, Any]:
    """
    Load threshold calibration from Stage 4.
