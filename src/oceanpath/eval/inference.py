"""
Inference engine for Stage 4 evaluation.

Loads final model artifacts from Stage 3 (best_fold, ensemble, refit)
...
def run_inference(
    ...
    feature_dir : directory of per-slide H5 feature files
    ...
    if strategy == "ensemble":
        return _ensemble_inference(
            ...
            verify_packed_source=verify_packed_source,
            force_float32=force_float32,
            eval_fixed_bag_size=eval_fixed_bag_size,
            short_bag_policy=short_bag_policy,
            cap_strategy=cap_strategy,
            cap_grid_size=cap_grid_size,
...
def _build_test_datamodule(
    ...
    dm = MILDataModule(
        ...
        return_coords=False,
        verify_splits=False,
        use_preallocated_collator=False,  # dynamic/full-bag test path
        force_float32=force_float32,
        packed_dir=packed_dir,
        verify_packed_source=verify_packed_source,
        eval_fixed_bag_size=eval_fixed_bag_size,
